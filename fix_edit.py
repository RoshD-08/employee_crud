...
content = re.sub(r'def edit_employee\(employee_id\):.*?return render_template\("edit_employee\.html", employee=existing, \*\*_form_constants\(\)\)', edit_employee_code.strip(), content, flags=re.DOTALL)
